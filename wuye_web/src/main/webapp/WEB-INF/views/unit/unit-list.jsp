                ...
                <div>
                    <ul class="nav nav-tabs" role="tablist" id="ulbody">
                        <li role="presentation" class="active">
                            <a href="#base" aria-controls="base" role="tab" data-toggle="tab">单元信息更改</a>
                        </li>
                            ...
                            <br/>
                                ...
                                <div>
                                    <table class="form-table ">
                                        ...
                                        <tr>
                                            <td class="form-title">
                                                <span class="text-danger">*</span>单元管理
                                            </td>
                                            <td>
                                                <input type="text"  class="form-control" value="" id="unitname">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="form-title">
...
<script id="template" type="x-tmpl-mustache">
            ...
            <tr>
                ...
                <input type="hidden" class="unitid" value = "{{id}}" >
...
<script type="text/javascript">
    ...
    $(".mytable").on("click",".update",function () {
        var unitname = $(this).siblings(".name").val();
        var note = $(this).siblings(".note").val();
        var id = $(this).siblings(".unitid").val();
    ...
    $(".mytable").on("click", "#del", function () {
        if (confirm("确定要删除吗？")) {
            ...
            window.location.href = "/unit/deleteunit?id="+id;
            return true;
        }
        return false;
    });
